...
<!--Start content-->
<section class="Psection MT20 Textcenter" id="Cflow">
  <!-- 订单提交成功后则显示如下 -->
  <p class="Font14 Lineheight35 FontW">恭喜你！订单提交成功！</p>
  <p class="Font14 Lineheight35 FontW">您的订单编号为：<span class="CorRed">${orders.id}</span></p>
  <p class="Font14 Lineheight35 FontW">共计金额：<span class="CorRed">${orders.amount}</span></p>
  <p><button type="button" class="Lineheight35"><a href="<%=basePath%>/payBuy/findAll.do">查看订单</button></p>
</section>
<!--End content-->
<footer>
