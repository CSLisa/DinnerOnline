...
<header>
 <section class="Topmenubg">
  <div class="Topnav">
   ...
   <div class="RightNav">
    <a href="<%=basePath%>/user_center.jsp">用户中心</a> <a href="<%=basePath%>/user_orderlist.jsp" target="_blank" title="我的订单">我的订单</a> <a href="../cartAndPay/cart.jsp">购物车（0）</a> <a href="user_favorites.jsp" target="_blank" title="我的收藏">我的收藏</a> <a href="#">商家入驻</a>
   </div>
  </div>
 </section>
 ...
 <article class="U-article Overflow">
  <section class="usercenter">
   ...
   <div class="U-header MT20 Overflow">
    ...
    <p class="Font14 FontW">欢迎您回到 用户中心！</p>
...
<footer>
 <section class="Otherlink">
  ...
  <section>
    ...
    <ul>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">支付方式</a></li>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">配送方式</a></li>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">配送效率</a></li>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">服务费用</a></li>
    </ul>
    </div>
    <div>
    <span><i class="i2"></i>关于我们</span>
    <ul>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">招贤纳士</a></li>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">网站介绍</a></li>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">配送效率</a></li>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">商家加盟</a></li>
    </ul>
    </div>
    <div>
    <span><i class="i3"></i>帮助中心</span>
    <ul>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">服务内容</a></li>
     <li><a href="<%=basePath%>/article_read.jsp" target="_blank" title="标题">服务介绍</a></li>
