...
<section class="Shop-index">
 ...
 <aside>
  <div class="cart" id="Topcart">
	<span class="Ctitle Block FontW Font14"><a href="../cartAndPay/cart.jsp" target="_blank">我的购物车</a></span>
	...
	<p class="Ptc"><span class="Cbutton"><a href="../cartAndPay/cart.jsp" target="进入购物车">进入购物车</a></span><span class="total">共计金额: ￥0</span></p>
  </div>
